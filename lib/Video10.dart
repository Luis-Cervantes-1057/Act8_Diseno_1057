...
class _DashboardState extends State<Dashboard> {
  final List<String> _repeat = ['Todo', 'Chest', 'Cardio', 'Lower'];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: CircleAvatar(
            backgroundImage: ExactAssetImage('assets/images/messi.png'),
          ),
        ),
        actions: <Widget>[
          Padding(
              ...
              children: <Widget>[
                ...
                Column(
                  children: [
                    ...
                    makeItem(
                        image: "assets/images/sabores.png",
                        title: "Sabor distintos\nIrresistibles"),
                    makeItem(
                        image: "assets/images/jugos.png",
                        title: "Jugos \nDeliciosos"),
                  ],
                )
              ],
